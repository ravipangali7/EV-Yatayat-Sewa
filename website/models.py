...
class CMSPage(models.Model):
    ...
    og_image = models.ImageField(upload_to='uploads/website/cms/og/', blank=True, null=True)
    og_image_alt = models.CharField(max_length=255, blank=True, default='')
    canonical_path = models.CharField(max_length=500, blank=True, default='')
...
class Service(models.Model):
    ...
    meta_title = models.CharField(max_length=255, blank=True, default='')
    meta_description = models.TextField(blank=True, default='')
    og_image = models.ImageField(upload_to='uploads/website/services/og/', blank=True, null=True)
    og_image_alt = models.CharField(max_length=255, blank=True, default='')
    canonical_path = models.CharField(max_length=500, blank=True, default='')
    robots_noindex = models.BooleanField(default=False)
...
class Blog(models.Model):
    ...
    meta_title = models.CharField(max_length=255, blank=True, default='')
    meta_description = models.TextField(blank=True, default='')
    og_image = models.ImageField(upload_to='uploads/website/blog/og/', blank=True, null=True)
    og_image_alt = models.CharField(max_length=255, blank=True, default='')
    canonical_path = models.CharField(max_length=500, blank=True, default='')
    robots_noindex = models.BooleanField(default=False)
    content = models.TextField(blank=True, default='')
...
class SiteSetting(models.Model):
    ...
    favicon = models.ImageField(upload_to='uploads/website/site/', blank=True, null=True)
    default_og_image = models.ImageField(upload_to='uploads/website/site/', blank=True, null=True)
    meta_title = models.CharField(max_length=255, blank=True, default='')
    meta_description = models.TextField(blank=True, default='')
    twitter_handle = models.CharField(max_length=100, blank=True, default='')
    facebook_app_id = models.CharField(max_length=32, blank=True, default='')
    og_locale = models.CharField(max_length=20, blank=True, default='en_US')
